...
if (runTests)
  test('component inside vs outside without scoping', async ({ page }) => {
...
if (runTests)
  test('Changing :host for SSR without scoping', async ({ page }) => {
...
if (runTests)
  test('Changing :host for SSR', async ({ page }) => {
...
if (runTests)
  test('Changing :host after hydration', async ({ page }) => {
